...
export const nigeriaStatesAndLGAs: StateWithLGAs[] = [
  {
    name: "Abia",
    lgas: [
  ...
  },
  {
    ...
    lgas: [
      ...
      "Etsako Central", "Etsako East", "Etsako West", "Igueben", "Ikpoba Okha", "Oovia",
  ...
  },
  {
    ...
    lgas: [
      ...
      "Dawkin Kudu", "Dawkin Tofa", "Doguwa", "Fagge", "Gabasawa", "Garko", "Garun Mallam",
...
export const getStateByName = (stateName: string): StateWithLGAs | undefined => {
  return nigeriaStatesAndLGAs.find(state => state.name === stateName);
};

export const getAllStates = (): string[] => {
  return nigeriaStatesAndLGAs.map(state => state.name);
};
